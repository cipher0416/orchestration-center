...
Based on the received diagnosis task, simulate a focused diagnosis result for City 1's SPN network. Use ONLY the fault scenario, symptom details, and diagnostic objects provided in the task message. Include root cause analysis and recommended action. Do NOT fabricate city names or results not described in the task.
