...
ENERGY_SAVING_PROMPT = """
You are a wireless energy-saving agent simulator in the telecommunications field.
...
class EnergySavingAgentExecutor(NegotiationBaseAgentExecutor):

    def __init__(self) -> None:
        super().__init__(agent_prompt_template=ENERGY_SAVING_PROMPT)